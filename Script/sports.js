...
const api_key = "540a02d33340407fa90f9010e62e59fe";


import { getdata, appenddata, america } from "../components/worldComp.js"; // .--------------- importing  function


const link_1 = ` https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=${api_key}`
...
const link_2 = ` https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=${api_key}`
...
const link_3 = ` https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=${api_key}`
...
const link_4 = ` https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=${api_key}`
...
const link_5 = ` https://newsapi.org/v2/top-headlines?country=nz&category=sports&apiKey=${api_key}`
...
const link_6 = ` https://newsapi.org/v2/top-headlines?country=nz&category=sports&apiKey=${api_key}`
...
const link_7 = ` https://newsapi.org/v2/top-headlines?country=nz&category=sports&apiKey=${api_key}`
...
const link_8 = ` https://newsapi.org/v2/top-headlines?country=za&category=sports&apiKey=${api_key}`
