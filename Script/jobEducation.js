...
let getData = async (page_number, per_page) => {
    const url = `https://newsapi.org/v2/everything?q=indian education&pageSize=${per_page}&page=${page_number}&apiKey=235cf2fee4224f6694f92501c48f98d1`
    try {
...
let showdata = async () => {
    ...
    const url = `https://newsapi.org/v2/everything?q=indian education&apiKey=235cf2fee4224f6694f92501c48f98d1`
    try {
        let res = await fetch(url);
